package sqlite.tcc.desenvolvimento.aplicacoes.dispositivos.moveis.tccsqlite.activity;
...
import sqlite.tcc.desenvolvimento.aplicacoes.dispositivos.moveis.tccsqlite.R;
...
import sqlite.tcc.desenvolvimento.aplicacoes.dispositivos.moveis.tccsqlite.model.dao.CapitulosDAO;
import sqlite.tcc.desenvolvimento.aplicacoes.dispositivos.moveis.tccsqlite.model.dao.LivrosDAO;
import sqlite.tcc.desenvolvimento.aplicacoes.dispositivos.moveis.tccsqlite.util.CronometroUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.livrosDAO = LivrosDAO.getInstance(this.getBaseContext());
        this.capitulosDAO = CapitulosDAO.getInstance(this.getBaseContext());
            ...
            public void onClick(View view) {
                ...
                if(qtdLivros.compareTo(new Long("0")) > 0) {
                    ...
                    for (int i = 0; i < qtdLivros; i++) {
                        ...
                        Livros livro = new Livros(null, tituloString, autorString, editoraString, capitulosList);

                        for (int j = 0; j < qtdCapitulos; j++) {
                            String titulo = "Capitulo Titulo";
                            String subtitulo = "Capitulo Subtitulo";

                            Capitulos capitulo = new Capitulos(null, titulo, subtitulo, livro);
